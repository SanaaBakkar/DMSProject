...
@if(count($workflowG) >0)
    <form method="post" action="{{ url('/taskGroup',array($workflowG->id)) }}">
                  {{csrf_field()}}

        <input type="text" name="ID_doc" value="{{$workflowG->id_doc}}" hidden/>
        ...
        <table width="100%" >
            ...
            <tr>
                <td colspan="3"><b>Message: </b> {{ $workflowG->description}}</td>
            </tr>
            <tr>
               <td width="33%"><b>Owner: </b> {{ $workflowG->created_by}}</td>
               <td width="33%"><b>Priority: </b> {{ $workflowG->priority}}</td>
               <td width="33%"><b>Due: </b> {{ $workflowG->due_date}}</td>
            </tr>
            <tr>
            ...
            <tr>
             ...
             <?php $docs = App\Edocument::find($workflowG->id_doc);?> 
            <tr>
