...
@if(count($workflowPooled) >0)
    <form method="post" action="{{ url('/taskPooled',array($workflowPooled->id)) }}">
                  {{csrf_field()}}

        <input type="text" name="ID_doc" value="{{$workflowPooled->id_doc}}" hidden/>
        ...
        <table width="100%" >
            ...
            <tr>
                <td colspan="3"><b>Message: </b> {{ $workflowPooled->description}}</td>
            </tr>
            <tr>
               <td width="33%"><b>Owner: </b> {{ $workflowPooled->created_by}}</td>
               <td width="33%"><b>Priority: </b> {{ $workflowPooled->priority}}</td>
               <td width="33%"><b>Due: </b> {{ $workflowPooled->due_date}}</td>
            </tr>
            <tr>
            ...
            <tr>
             ...
             <?php $docs = App\Edocument::find($workflowPooled->id_doc);?> 
            <tr>
